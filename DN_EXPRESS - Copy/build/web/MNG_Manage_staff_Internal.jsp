                        ...
                        <table>
                            <header>
                                <div class="filterEntries">
                                    <div class="addMemberBtn">
                                        <button class="btn btn-primary" onclick="window.location.href = 'MNG_Create_Staff_Internal.jsp'">
                                            New Staff</button>
                                    </div>
                            ...
                            <tbody>
                                ...
                                <c:forEach var="staff" items="${sList}" varStatus="loop">
                                    <tr>
                                        <td>${loop.index + 1}</td>
                                        <td>${staff.account.getFirstName()} ${staff.account.getLastName()}</td>
                                        ...
                                        <td style="display: flex; justify-content: center;">
                                            ...
                                            <button class="action-btn edit-btn" 
                                                    onclick="window.location.href = 'Manger_editStaffDetails_Servlet?account_id=${staff.account.getAccount_id()}'">
                                                <i class="fa-regular fa-pen-to-square"></i>
                                            </button>

                                            <button class="action-btn delete-btn" 
                                                    onclick="showDeletePopup(${staff.account.getAccount_id()})"><i class="fa-regular fa-trash-can"></i>
                                            </button>
                        ...
                        <div class="inputFieldContainer">
                            <div class="nameField">
                                <div class="form_control">
                                    ...
                                    <input type="text" id="fName" readonly required>
                                </div>
                                <div class="form_control">
                                    <label for="lName">Last Name:</label>
                                    <input type="text" id="lName" readonly required>
                                </div>
                            </div>
                            <div class="identify">
                                <div class="form_control">
                                    <label for="account_id">Account ID:</label>
                                    <input type="text" id="account_id" readonly required>
                                </div>
                                <div class="form_control">
                                    <label for="gender">Gender:</label>
                                    <input type="text" id="gender" readonly required>
                                </div>
                            </div>
                            <div class="location">
                                ...
                                <div class="form_control">
                                    ...
                                    <input type="text" id="cid" readonly required>
                                </div>
                                <div class="form_control">
                                    <label for="post_officeID">Post Office ID:</label>
                                    <input type="text" id="post_officeID" readonly required>
                                </div>
                            </div>

                            <div class="form_control">
                                <label for="dob">Date of Birth:</label>
                                <input type="date" id="dob" readonly required>
                            </div>
                            <div class="form_control">
                            ...
                            <div class="form_control">
                                ...
                                <input type="number" id="phone" readonly required>
                            </div>
                        </div>
        ...
        <script>
            ...
            document.querySelectorAll('.view-btn').forEach(button => {
                button.addEventListener('click', function () {
                    ...
                    xhr.open('GET', 'Manager_listStaffInternal_Servlet?accountId=' + encodeURIComponent(accountId), true);
                    xhr.onload = function () {
