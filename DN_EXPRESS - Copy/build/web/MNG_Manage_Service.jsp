                            ...
                            <header>
                                <div class="filterEntries">
                                    <div class="addMemberBtn">
                                        <button class="btn btn-primary" onclick="window.location.href = 'MNG_Add_Service_Details.jsp'">New Service</button>
                                    </div>
                                    <form action="Manager_searchService_Servlet" method="post">
                                        <div class="filter" >
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="action-btn view-btn"  
                                                    onclick="window.location.href = 'Manager_getServiceDetails_Servlet?service_type_id=${service.service_type_id}'">
                                                <i class="fa-regular fa-eye"></i></button>
                                            <button class="action-btn edit-btn" 
                                                    onclick="window.location.href = 'Manager_editService_Servlet?service_type_id=${service.service_type_id}'">
        ...
        <script>
                                                        function showDeletePopup(accountId) {
                                                            ...
                                                            confirmDeleteBtn.onclick = function () {
                                                                window.location.href = 'Manager_deleteService_Servlet?service_type_id=' + accountId;
                                                            };
        ...
        <script>
            ...
            function search() {
                ...
                if (searchTerm !== '') {
                    ...
                    window.location.href = 'Manager_searchService_Servlet?searchCriteria=' + encodeURIComponent(searchTerm);
                }
            }
        </script>
