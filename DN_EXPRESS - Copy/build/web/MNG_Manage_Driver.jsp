                        ...
                        <table>
                            <header>
                                <div class="filterEntries">
                                    <div class="addMemberBtn ">
                                        <button class="btn btn-primary" onclick="window.location.href = 'MNG_Create_Driver.jsp'">New Driver</button>
                                    </div>
                            ...
                            <tbody>
                                ...
                                <c:forEach var="driver" items="${dList}" varStatus="loop">
                                    <tr>
                                        <td>${loop.index + 1}</td>
                                        <td>${driver.account.getFirstName()} ${driver.account.getLastName()}</td>
                                        ...
                                        <td>
                                            ...
                                            <button class="action-btn edit-btn" 
                                                    onclick="window.location.href = 'Manager_editDriverDetails_Servlet?account_id=${driver.account.getAccount_id()}&driver_type_id=${driver.driver_type.getDriv_type_id()}'">
        ...
        <script>
            function showDeletePopup(accountId) {
                ...
                confirmDeleteBtn.onclick = function () {
                    window.location.href = 'Manager_deleteDriver_Servlet?account_id=' + accountId;
                };
        ...
        <script>
            ...
            document.querySelectorAll('.view-btn').forEach(button => {
                button.addEventListener('click', function () {
                    ...
                    xhr.open('GET', 'Manager_getDriverDetails_Servlet?accountId=' + encodeURIComponent(accountId), true);
                    xhr.onload = function () {
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                viewBtns.forEach(function (btn) {
                    btn.addEventListener('click', function () {
                        ...
                        xhr.open('GET', 'Manager_getDriverDetails_Servlet?accountId=' + accountId);
                        xhr.send();
                    });
                });
