                                ...
                                <div class="form-container right-bar">
                                    ...
                                    <div class="container">
                                        <div class="col-md-10">
                                            ...
                                            <form class="form-container" action="Svl_Profile_Manager" method="post">

                                                <div class="form-group">
                                                    <label>First Name</label>
                                                    <div class="input-container">
                                                        <input class="text" type="text" name="fname" value="${info.getFirstName()}" readonly >
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label>Last Name</label>
                                                    <div class="input-container">
                                                        <input class="text" type="text" name="lname" value="${info.getLastName()}" readonly>
                                                ...
                                                <div class="form-group gender">
                                                    ...
                                                    <div class="input-container">
                                                        <input type="radio" id="male" name="select-gen" value="Male" ${info.getGender() == 'Male' ? 'checked' : ''} disabled>
                                                        <label for="male">Male</label>
                                                        <input type="radio" id="female" name="select-gen" value="Female" ${info.getGender() == 'Female' ? 'checked' : ''} disabled>
                                                        <label for="female">Female</label>
                                                        <input type="radio" id="other" name="select-gen" value="Other" ${info.getGender() == 'Other' ? 'checked' : ''} disabled>
                                                ...
                                                <div class="form-group">
                                                    <label>Email</label>
                                                    <div class="input-container">
                                                        <input type="email" name="email" value="${info.getEmail()}" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-container">
                                                        <input type="tel" id="phone" name="phone" value="${info.getPhone_numb()}" pattern="0[0-9]{9,10}" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-container">
                                                        <input type="text" id="idNumber" name="idNumber"  value="${info.getCccd_numb()}"  pattern="[0-9]{9,10,11}" readonly>
                                                    </div>
                                                </div>
                                            </form>  
                                            <p class="error">${msg}</p>
                                            <c:set var="msg" value="${null}" scope="session"></c:set>
                                                <form action="Svl_EditProfile_Manager" method="get">
                                                    <div class="form-group">                                                  
