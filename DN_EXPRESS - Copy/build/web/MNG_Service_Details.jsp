...
<html lang="en">
    ...
    <body>
        ...
        <section class="confiq">
            <!-- SIDEBAR -->
            <%@include file="/include/sidebar_mng.jsp" %>        <!-- SIDEBAR -->
                    ...
                    <div class="dark_bg active">
                        ...
                        <div class="popup active" >
                            ...
                            <footer class="popupFooter">
                                <button class="submitBtn btn btn-primary" onclick="goBack()" >Back</button>
                            </footer>
                        </div>
                    </div>
        ...
        <script>
                               function goBack() {
                                   window.location.href = 'Manager_listService_Servlet';
                               }
        </script>
    </body>
