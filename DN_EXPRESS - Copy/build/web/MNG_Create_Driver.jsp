        ...
        <section class="confiq">
            ...
            <section id="content">
                ...
                <nav>
                    ...
                    <a href="listStaff" class="nav-link"><strong>Manage Driver</strong></a>
                    <form action="#">
                ...
                <main class="table" id="customers_table">
                    ...
                    <div class="dark_bg active">
                        ...
                        <div class="popup active" >
                            ...
                            <div class="body">
                                <form action="Manager_createDriver_Servlet" id="myForm"method="post" enctype="multipart/form-data">
                                    <div class="imgholder">
                                    ...
                                    <div class="inputFieldContainer">
                                        ...
                                        <div class="nameField">
                                            <div class="form_control">
                                                ...
                                                <input  type="text" name="fistName" id="fName" pattern="[A-Za-z]+" title="First name must contain only letters." required>
                                            </div>
                                            <div class="form_control">
                                        ...
                                        <div class="location">
                                            <div class="form_control">
                                                ...
                                                <h5 style="color:red">${requestScope.errorMessage1}</h5>
                                            </div>
