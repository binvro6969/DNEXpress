<%-- 
    Document   : Scr_ErrorPage
    Created on : Jul 1, 2024, 10:14:20 PM
    Author     : haian
--%>
            ...
            <div class="card mt-5 border-0 shadow rounded-3">
              <div class="container">
                <div class="card-body text-center">
                  <i class="fa-solid fa-circle-xmark fail"></i>
                  <h2 class="card-title ">Have something wrong</h2>
                  <p>You can try again later</p>
                  
                  <div class="d-grid mb-2 justify-content-center">
                      <a href="landing_page.jsp" class="btn_back btn-primary fw-bold">Back</a>
                </div> 
              </div>
              </div>
