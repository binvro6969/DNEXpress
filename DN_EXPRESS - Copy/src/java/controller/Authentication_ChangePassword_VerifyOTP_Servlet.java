 ...
 * @author haian
 */
public class Authentication_ChangePassword_VerifyOTP_Servlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
         ...
         HttpSession session = request.getSession();
            ...
            if(code.equals(userEmail.getCode())){
                request.getRequestDispatcher("Scr_ForgotPassword_ChangePass.jsp").forward(request, response);
            }else{
                String msg ="incorrect OTP";
                request.setAttribute("message", msg);
                request.getRequestDispatcher("Scr_ForgotPassword_EnterCode.jsp").forward(request, response);
            }
    }
