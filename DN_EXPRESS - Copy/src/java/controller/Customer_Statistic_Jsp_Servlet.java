 ...
 * @author dangq
 */
public class Customer_Statistic_Jsp_Servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Customer_Statistic_Jsp_Servlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Customer_Statistic_Jsp_Servlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(session.getAttribute("loginSession")==null){
            ...
            List<Integer> orderYears = customerImplement.getDistinctOrderYears(cusId);
            ...
            double totalAmount = customerImplement.getCustomerExpenses(cusId);
            ...
            // Forward to the JSP
            request.getRequestDispatcher("CUS_Statistic.jsp").forward(request, response);
        }
