            ...
            <section id="content">
                ...
                <main class="table" id="customers_table">
                    ...
                    <body>
                        ...
                        <c:set var="pick_up_address" value="${requestScope.pick_up_address}" /> 
                        ...
                        <div class="reiceve_card">
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    <div class="card">
                                        <address>
                                            ...
                                            <c:if test="${requestScope.check_InProvince == false}">
                                                <strong>Address:</strong><br />
                                                Bưu cục<br />
                                            </c:if>
                                            <c:if test="${requestScope.check_InProvince == true}">
                                                <strong>Address:</strong><br />
                                                ${final_address}<br />
                                            </c:if>    
                                ...
                                <div class="btn_choose">
                                    <a href="Driver_ReceiveOrder_AcceptOrder_Servlet?id=${shipment_Order_infor.shipment_order.order_id}" class="button--full"><button class="btn_arrived button--full">Accept</button></a>
                                    <a href="Driver_ReceiveOrder_CancelOrder_Servlet?id=${shipment_Order_infor.shipment_order.order_id}" class="button--full"><button class="btn_cancel button--full">Cancel</button></a>
