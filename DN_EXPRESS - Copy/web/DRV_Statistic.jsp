<%-- 
    Document   : Driver_Statistic
    Created on : Jun 17, 2024, 3:43:14 PM
    Author     : dangq
--%>
...
<html lang="en">
    ...
    <head>
        ...
        <!-- My CSS -->
        <link rel="stylesheet" href="css/driver_statistic_style.css">
    ...
    <body>
        <section class="confiq">
            ...
            <section id="content">
                ...
                <nav>
                    ...
                    <a href="#" class="nav-link"><strong>Driver Statistic</strong></a>
                    <form action="#">
        ...
        <script src="js/driver_statistic.js"></script>
    </body>
