...
<head>
    ...
    <!-- My CSS -->
    <link href="css/sta_inspectPackage.css" rel="stylesheet" type="text/css"/>
...
<body>
                ...
                <div class="table-data">
                    ...
                    <div class="request_line">
                        <div class="head">
                            ...
                            <i class='bx bx-plus' style="font-size: 1.5em;" id="btn_CreateTicket" onclick="redirectToAction()"></i>
                                    ...
                                    <c:forEach var="ticket" items="${ticketList}">
                                        <c:if test="${ticket.ticket_status.ticket_status_id == 1}">
                                            <li class="completed">
                                                ...
                                                <button><i class="viewInforBtn fa-regular fa-pen-to-square"></i></button>
                                            </li>
                                        </c:if>
    ...
    <script src="js/sta_inspectPackage.js" type="text/javascript"></script>
   <script>
    function redirectToAction() {
        window.location.href = 'sta_inspectPackage_createTicket'; // Replace with your servlet action URL
    }
    </script>
</body>
